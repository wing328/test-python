...
class SdwanRouterPolicy(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            deployment_size (str): Scale of the SD-WAN router virtual machine deployment.. [optional] if omitted the server will use the default value of "Typical"  # noqa: E501
            wan_count (int): Number of WAN connections across the SD-WAN site.. [optional]  # noqa: E501
            wan_termination_type (str): Defines if the WAN networks are singly or dually terminated. Dually terminated WANs are configured on all the SD-WAN routers. Singly terminated WANs are configured only on one of the SD-WAN routers.. [optional] if omitted the server will use the default value of "Single"  # noqa: E501
