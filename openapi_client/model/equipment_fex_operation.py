...
class EquipmentFexOperation(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            admin_locator_led_action (str): Action performed on the locator LED for a FEX.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            admin_locator_led_action_state (str): Defines status of action performed on AdminLocatorLedState.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
