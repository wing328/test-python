...
def lazy_import():
    ...
    globals()['ComputeServerSettingAllOf'] = ComputeServerSettingAllOf
...
class ComputeServerSetting(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """ComputeServerSetting - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            admin_locator_led_state (str): User configured state of the locator LED for the server.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            admin_power_state (str): User configured power state of the server.. [optional] if omitted the server will use the default value of "Policy"  # noqa: E501
            config_state (str): The configured state of these settings in the target server. The value is any one of Applied, Applying, Failed. Applied - This state denotes that the settings are applied successfully in the target server. Applying - This state denotes that the settings are being applied in the target server. Failed - This state denotes that the settings could not be applied in the target server.. [optional] if omitted the server will use the default value of "Applied"  # noqa: E501
