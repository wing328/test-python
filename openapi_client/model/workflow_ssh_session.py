...
class WorkflowSshSession(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            message_type (str): The type of SSH message to send to the remote server.. [optional] if omitted the server will use the default value of "ExecuteCommand"  # noqa: E501
