...
def lazy_import():
    ...
    globals()['CapabilitySectionAllOf'] = CapabilitySectionAllOf
...
class CapabilitySection(ModelComposed):
    ...
    allowed_values = {
        ('action',): {
            'NONE': "None",
            'LOADLOCAL': "LoadLocal",
            'LOADINTERSIGHTREPOSITORY': "LoadIntersightRepository",
        },
        ('source',): {
            'LOCAL': "Local",
            'INTERSIGHTREPOSITORY': "IntersightRepository",
        },
    }
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """CapabilitySection - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            action (str): Administrative action to initialize/load the catalog section from a particular source.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            catalog_name (str): The catalog name reference.. [optional]  # noqa: E501
            name (str): A unique name for the section inside a catalog.. [optional]  # noqa: E501
            source (str): The configured source for this section of the catalog.. [optional] if omitted the server will use the default value of "Local"  # noqa: E501
            version (str): Version of the section inside a catalog.. [optional]  # noqa: E501
