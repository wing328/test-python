...
def lazy_import():
    ...
    globals()['ApplianceDeviceClaimAllOf'] = ApplianceDeviceClaimAllOf
...
class ApplianceDeviceClaim(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """ApplianceDeviceClaim - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            platform_type (str): Platform type of the endpoint device.. [optional] if omitted the server will use the default value of ""  # noqa: E501
            ...
            status (str): Status of the device claim process.. [optional] if omitted the server will use the default value of "started"  # noqa: E501
