...
class SnmpUser(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            auth_type (str): Authorization protocol for authenticating the user.. [optional] if omitted the server will use the default value of "NA"  # noqa: E501
            is_auth_password_set (bool): Indicates whether the value of the &#39;authPassword&#39; property has been set.. [optional]  # noqa: E501
            is_privacy_password_set (bool): Indicates whether the value of the &#39;privacyPassword&#39; property has been set.. [optional]  # noqa: E501
            ...
            privacy_type (str): Privacy protocol for the user.. [optional] if omitted the server will use the default value of "NA"  # noqa: E501
            security_level (str): Security mechanism used for communication between agent and manager.. [optional] if omitted the server will use the default value of "AuthPriv"  # noqa: E501
        """
