...
class TelemetryDruidDimensionSpec(ModelComposed):
    ...
    def __init__(self, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            output_name (str): null. defaults to nulltype.Null  # noqa: E501
            output_type (str): null. defaults to nulltype.Null, must be one of ["STRING", "LONG", "FLOAT", ]  # noqa: E501
        ...
        output_name = kwargs.get('output_name', nulltype.Null)
        output_type = kwargs.get('output_type', nulltype.Null)
        extraction_fn = kwargs.get('extraction_fn', nulltype.Null)
