...
class SyslogLocalClientBase(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            min_severity (str): Lowest level of messages to be included in the local log.. [optional] if omitted the server will use the default value of "warning"  # noqa: E501
        """
