...
class SshPolicy(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            enabled (bool): State of SSH service on the endpoint.. [optional]  # noqa: E501
            port (int): Port used for secure shell access.. [optional]  # noqa: E501
            timeout (int): Number of seconds to wait before the system considers a SSH request to have timed out.. [optional]  # noqa: E501
