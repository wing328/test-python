...
class WorkflowErrorResponseHandler(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'parameters': ([ContentParameter],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            parameters ([ContentParameter]): [optional]  # noqa: E501
            platform_type (str): The platform type for which the error response handler is defined.. [optional] if omitted the server will use the default value of ""  # noqa: E501
