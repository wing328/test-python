...
class VmediaPolicy(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'mappings': ([VmediaMapping],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            enabled (bool): State of the Virtual Media service on the endpoint.. [optional]  # noqa: E501
            encryption (bool): If enabled, allows encryption of all Virtual Media communications.. [optional]  # noqa: E501
            low_power_usb (bool): If enabled, the virtual drives appear on the boot selection menu after mapping the image and rebooting the host.. [optional]  # noqa: E501
            mappings ([VmediaMapping]): [optional]  # noqa: E501
