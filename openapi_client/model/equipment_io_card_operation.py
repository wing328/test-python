...
class EquipmentIoCardOperation(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            admin_power_state (str): User configured power state of the iomodule.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            config_state (str): The configured state of these settings in the target chassis. The value is any one of Applied, Applying, Failed. Applied - This state denotes that the settings are applied successfully in the target chassis iomodule. Applying - This state denotes that the settings are being applied in the target chassis iomodule. Failed - This state denotes that the settings could not be applied in the target chassis iomodule.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
