...
def lazy_import():
    ...
    globals()['StorageStoragePolicyAllOf'] = StorageStoragePolicyAllOf
    globals()['StorageVirtualDriveConfig'] = StorageVirtualDriveConfig


class StorageStoragePolicy(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'global_hot_spares': ([StorageLocalDisk],),  # noqa: E501
            'retain_policy_virtual_drives': (bool,),  # noqa: E501
            'unused_disks_state': (str,),  # noqa: E501
            'virtual_drives': ([StorageVirtualDriveConfig],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """StorageStoragePolicy - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            global_hot_spares ([StorageLocalDisk]): [optional]  # noqa: E501
            retain_policy_virtual_drives (bool): Retains the virtual drives defined in policy if they exist already. If this flag is false, the existing virtual drives are removed and created again based on virtual drives in the policy.. [optional]  # noqa: E501
            unused_disks_state (str): Unused Disks State is used to specify the state, unconfigured good or jbod, in which the disks that are not used in this policy should be moved.. [optional] if omitted the server will use the default value of "UnconfiguredGood"  # noqa: E501
            virtual_drives ([StorageVirtualDriveConfig]): [optional]  # noqa: E501
