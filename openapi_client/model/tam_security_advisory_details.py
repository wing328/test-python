...
class TamSecurityAdvisoryDetails(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            status (str): Cisco assigned status of the published advisory. Depends on whether the investigation is complete or on-going.. [optional] if omitted the server will use the default value of "interim"  # noqa: E501
