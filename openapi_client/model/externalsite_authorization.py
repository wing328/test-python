...
class ExternalsiteAuthorization(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            repository_type (str): The repository type to which this authorization will be requested. Cisco is the only available repository today.. [optional] if omitted the server will use the default value of "cisco"  # noqa: E501
