...
class AssetTarget(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'connections': ([AssetConnection],),  # noqa: E501
            'services': ([AssetService],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            connections ([AssetConnection]): [optional]  # noqa: E501
            services ([AssetService]): [optional]  # noqa: E501
            status (str): Status indicates if Intersight can establish a connection and authenticate with the managed target. Status does not include information about the functional health of the target.. [optional] if omitted the server will use the default value of ""  # noqa: E501
            status_error_reason (str): StatusErrorReason provides additional context for the Status.. [optional]  # noqa: E501
            target_type (str): The type of the managed target. For example a UCS Server or Vmware Vcenter target.. [optional] if omitted the server will use the default value of ""  # noqa: E501
