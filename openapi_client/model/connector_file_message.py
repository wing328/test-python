...
def lazy_import():
    ...
    globals()['ConnectorFileMessageAllOf'] = ConnectorFileMessageAllOf


class ConnectorFileMessage(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """ConnectorFileMessage - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            msg_type (str): Message type carrying the file operation to perform.. [optional] if omitted the server will use the default value of "OpenFile"  # noqa: E501
            ...
            stream (str): The stream of bytes to write to file. Only applicable for FileContent message. Ignored for OpenFile and CloseFile messages.. [optional]  # noqa: E501
