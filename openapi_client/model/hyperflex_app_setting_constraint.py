...
class HyperflexAppSettingConstraint(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            mgmt_platform (str): The supported management platform for the HyperFlex Cluster.. [optional] if omitted the server will use the default value of "FI"  # noqa: E501
