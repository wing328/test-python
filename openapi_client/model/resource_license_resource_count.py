...
def lazy_import():
    ...
    globals()['ResourceLicenseResourceCountAllOf'] = ResourceLicenseResourceCountAllOf


class ResourceLicenseResourceCount(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """ResourceLicenseResourceCount - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            license_type (str): Type of licensing defined for this resource group. Used for licensing group.. [optional] if omitted the server will use the default value of "Base"  # noqa: E501
