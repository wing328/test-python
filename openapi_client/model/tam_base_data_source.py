...
def lazy_import():
    ...
    globals()['TamBaseDataSourceAllOf'] = TamBaseDataSourceAllOf
    globals()['TamTextFsmTemplateDataSource'] = TamTextFsmTemplateDataSource


class TamBaseDataSource(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """TamBaseDataSource - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Type of data source (for e.g. TextFsmTempalate based, Intersight API based etc.).. [optional] if omitted the server will use the default value of "nxos"  # noqa: E501
        """
