...
class WorkflowSshCmd(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'expect_prompts': ([ConnectorExpectPrompt],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            command_type (str): SSH command type to execute on the remote server.. [optional] if omitted the server will use the default value of "NonInteractiveCmd"  # noqa: E501
            expect_prompts ([ConnectorExpectPrompt]): [optional]  # noqa: E501
