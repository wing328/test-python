...
def lazy_import():
    ...
    globals()['RecoveryOnDemandBackupAllOf'] = RecoveryOnDemandBackupAllOf


class RecoveryOnDemandBackup(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """RecoveryOnDemandBackup - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            is_password_set (bool): Indicates whether the value of the &#39;password&#39; property has been set.. [optional]  # noqa: E501
            location_type (str): Specifies whether the backup will be stored locally or remotely.. [optional] if omitted the server will use the default value of "Network Share"  # noqa: E501
            ...
            protocol (str): Protocol for transferring the backup image to the network share location.. [optional] if omitted the server will use the default value of "SCP"  # noqa: E501
            retention_count (int): Number of backup copies maintained on the local or remote server. When the created backup files exceed this number, the initial backup files are overwritten in a sequential manner.. [optional]  # noqa: E501
            user_name (str): Backup server user name.. [optional]  # noqa: E501
        """
