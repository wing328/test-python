...
class WorkflowWorkflowMeta(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'input_parameters': ([str],),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            input_parameters ([str]): [optional]  # noqa: E501
            ...
            retryable (bool): When true, this workflow can be retried for 2 weeks since the last modification of the workflow.. [optional]  # noqa: E501
            ...
            type (str): The type of workflow definition.. [optional] if omitted the server will use the default value of "SystemDefined"  # noqa: E501
            version (int): The version for the workflow so we can support multiple versions for the same workflow name.. [optional]  # noqa: E501
