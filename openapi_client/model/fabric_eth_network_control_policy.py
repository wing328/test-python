...
class FabricEthNetworkControlPolicy(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            cdp_enabled (bool): Enables the CDP on an interface.. [optional]  # noqa: E501
            forge_mac (str): Determines if the MAC forging is allowed or denied on an interface.. [optional] if omitted the server will use the default value of "allow"  # noqa: E501
            lldp_settings (FabricLldpSettings): [optional]  # noqa: E501
            mac_registration_mode (str): Determines the MAC addresses that have to be registered with the switch.. [optional] if omitted the server will use the default value of "nativeVlanOnly"  # noqa: E501
            uplink_fail_action (str): Determines the state of the virtual interface (vethernet / vfc) on the switch when a suitable uplink is not pinned.. [optional] if omitted the server will use the default value of "linkDown"  # noqa: E501
