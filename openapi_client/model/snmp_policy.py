...
class SnmpPolicy(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'snmp_traps': ([SnmpTrap],),  # noqa: E501
            'snmp_users': ([SnmpUser],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            community_access (str): Controls access to the information in the inventory tables. Applicable only for SNMPv1 and SNMPv2c users.. [optional] if omitted the server will use the default value of "Disabled"  # noqa: E501
            enabled (bool): State of the SNMP Policy on the endpoint. If enabled, the endpoint sends SNMP traps to the designated host.. [optional]  # noqa: E501
            engine_id (str): User-defined unique identification of the static engine.. [optional]  # noqa: E501
            snmp_port (int): Port on which Cisco IMC SNMP agent runs.. [optional]  # noqa: E501
            snmp_traps ([SnmpTrap]): [optional]  # noqa: E501
            snmp_users ([SnmpUser]): [optional]  # noqa: E501
