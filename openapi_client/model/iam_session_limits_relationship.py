...
class IamSessionLimitsRelationship(ModelComposed):
    ...
    def __init__(self, class_id, *args, **kwargs):  # noqa: E501
        """IamSessionLimitsRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            idle_time_out (int): The idle timeout interval for the web session in seconds. When a session is not refreshed for this duration, the session is marked as idle and removed.. [optional]  # noqa: E501
            maximum_limit (int): The maximum number of sessions allowed in an account. The default value is 128.. [optional]  # noqa: E501
            per_user_limit (int): The maximum number of sessions allowed per user. Default value is 32.. [optional]  # noqa: E501
            session_time_out (int): The session expiry duration in seconds.. [optional]  # noqa: E501
