...
class LicenseLicenseInfo(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            license_state (str): The license state defined by Intersight. The value may be one of NotLicensed, TrialPeriod, OutOfCompliance, Compliance, GraceExpired, or TrialExpired.. [optional] if omitted the server will use the default value of "NotLicensed"  # noqa: E501
            license_type (str): The name of the Intersight license entitlement. For example, this property may be set to &#39;Essential&#39;.. [optional] if omitted the server will use the default value of "Base"  # noqa: E501
