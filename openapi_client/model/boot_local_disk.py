...
class BootLocalDisk(ModelComposed):
    ...
    validations = {
        ('slot',): {
            'regex': {
                'pattern': r'^([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]|M|HBA|SAS|MRAID|RAID|MSTOR-RAID)$',  # noqa: E501
            },
        },
        ('name',): {
            'regex': {
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            slot (str): The slot id of the local disk device. Supported values are (1-255, \&quot;M\&quot;, \&quot;HBA\&quot;, \&quot;SAS\&quot;, \&quot;RAID\&quot;, \&quot;MRAID\&quot;, \&quot;MSTOR-RAID\&quot;).. [optional]  # noqa: E501
