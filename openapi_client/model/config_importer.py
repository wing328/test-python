...
class ConfigImporter(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            import_source (str): The source of the archive in Intersight storage that has all the MOs to be imported.. [optional] if omitted the server will use the default value of "ImageRepo"  # noqa: E501
            name (str): An identifier for the importer instance.. [optional]  # noqa: E501
            skip_integrity_checks (bool): Specifies whether integrity checks must be skipped.. [optional]  # noqa: E501
            status (str): Status of the import operation.. [optional] if omitted the server will use the default value of ""  # noqa: E501
