...
def lazy_import():
    ...
    globals()['VnicEthAdapterPolicyAllOf'] = VnicEthAdapterPolicyAllOf
...
class VnicEthAdapterPolicy(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """VnicEthAdapterPolicy - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            advanced_filter (bool): Enables advanced filtering on the interface.. [optional]  # noqa: E501
            ...
            interrupt_scaling (bool): Enables Interrupt Scaling on the interface.. [optional]  # noqa: E501
            ...
            rss_settings (bool): Receive Side Scaling allows the incoming traffic to be spread across multiple CPU cores.. [optional]  # noqa: E501
            ...
            uplink_failback_timeout (int): Uplink Failback Timeout in seconds when uplink failover is enabled for a vNIC. After a vNIC has started using its secondary interface, this setting controls how long the primary interface must be available before the system resumes using the primary interface for the vNIC.. [optional]  # noqa: E501
