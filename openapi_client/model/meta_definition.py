...
class MetaDefinition(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'access_privileges': ([MetaAccessPrivilege],),  # noqa: E501
            'ancestor_classes': ([str],),  # noqa: E501
            ...
            'properties': ([MetaPropDefinition],),  # noqa: E501
            'rbac_resource': (bool,),  # noqa: E501
            'relationships': ([MetaRelationshipDefinition],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            access_privileges ([MetaAccessPrivilege]): [optional]  # noqa: E501
            ancestor_classes ([str]): [optional]  # noqa: E501
            is_concrete (bool): Boolean flag to specify whether the meta class is a concrete class or not.. [optional]  # noqa: E501
            meta_type (str): Indicates whether the meta class is a complex type or managed object.. [optional] if omitted the server will use the default value of "ManagedObject"  # noqa: E501
            ...
            properties ([MetaPropDefinition]): [optional]  # noqa: E501
            rbac_resource (bool): Boolean flag to specify whether instances of this class type can be assigned to resource groups that are part of an organization for access control. Inventoried physical/logical objects which needs access control should have rbacResource&#x3D;yes. These objects are not part of any organization by default like device registrations and should be assigned to organizations for access control. Profiles, policies, workflow definitions which are created by specifying organization need not have this flag set.. [optional]  # noqa: E501
            relationships ([MetaRelationshipDefinition]): [optional]  # noqa: E501
