...
class VnicSanConnectivityPolicy(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            placement_mode (str): The mode used for placement of vnics on network adapters. It can either be Auto or Custom.. [optional] if omitted the server will use the default value of "custom"  # noqa: E501
