...
def lazy_import():
    ...
    globals()['BootPrecisionPolicyAllOf'] = BootPrecisionPolicyAllOf
...
class BootPrecisionPolicy(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'boot_devices': ([BootDeviceBase],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """BootPrecisionPolicy - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            boot_devices ([BootDeviceBase]): [optional]  # noqa: E501
            configured_boot_mode (str): Sets the BIOS boot mode. UEFI uses the GUID Partition Table (GPT) whereas Legacy mode uses the Master Boot Record (MBR) partitioning scheme.. [optional] if omitted the server will use the default value of "Legacy"  # noqa: E501
            enforce_uefi_secure_boot (bool): If UEFI secure boot is enabled, the boot mode is set to UEFI by default. Secure boot enforces that device boots using only software that is trusted by the Original Equipment Manufacturer (OEM).. [optional]  # noqa: E501
