...
class FirmwareComponentMeta(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'model': (str,),  # noqa: E501
            'oob_manageability': ([str],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            component_type (str): The type of component image within the distributable.. [optional] if omitted the server will use the default value of "ALL"  # noqa: E501
            description (str): This shows the description of component image within the distributable.. [optional]  # noqa: E501
            disruption (str): The type of disruption on each component. For example, host reboot, automatic power cycle, and manual power cycle.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            is_oob_supported (bool): If set, the component can be updated through out-of-band management, else, is updated through the booting host service utility.. [optional]  # noqa: E501
            model (str): The model of the component image in the distributable.. [optional]  # noqa: E501
            oob_manageability ([str]): [optional]  # noqa: E501
            packed_version (str): The packaged version of component image within the distributable.. [optional]  # noqa: E501
            redfish_url (str): The redfish target for each component.. [optional]  # noqa: E501
            vendor (str): The version of the component image in the distributable.. [optional]  # noqa: E501
        """
