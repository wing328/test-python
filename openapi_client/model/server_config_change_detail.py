...
class ServerConfigChangeDetail(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            config_change_flag (str): Config change flag to differentiate Pending-changes and Config-drift.. [optional] if omitted the server will use the default value of "Pending-changes"  # noqa: E501
            disruptions ([str]): [optional]  # noqa: E501
            message (bool, date, datetime, dict, float, int, list, str, none_type): Detailed description of the config change.} type: string. [optional]  # noqa: E501
            mod_status (str): Modification status of the mo in this config change.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
        """
