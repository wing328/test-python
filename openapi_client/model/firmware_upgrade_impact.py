...
class FirmwareUpgradeImpact(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'exclude_components': ([str],),  # noqa: E501
            'impacts': ([FirmwareBaseImpact],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            components ([str]): [optional]  # noqa: E501
            computation_state (str): Captures the status of an upgrade impact calculation. Indicates whether the calculation is complete, in progress or the calculation is impossible due to the absence of the target image on the endpoint.. [optional] if omitted the server will use the default value of "Inprogress"  # noqa: E501
            exclude_components ([str]): [optional]  # noqa: E501
            impacts ([FirmwareBaseImpact]): [optional]  # noqa: E501
            summary (str): The summary on the component or components getting impacted by the upgrade.. [optional] if omitted the server will use the default value of "Basic"  # noqa: E501
        """
