...
class BiosSystemBootOrderRelationship(ModelComposed):
    ...
    def __init__(self, class_id, *args, **kwargs):  # noqa: E501
        """BiosSystemBootOrderRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            boot_mode (str): The BIOS boot mode. UEFI uses the GUID Partition Table (GPT) whereas Legacy mode uses the Master Boot Record (MBR) partitioning scheme.. [optional] if omitted the server will use the default value of "Legacy"  # noqa: E501
            dn (str): The Distinguished Name for this object, used to uniquely identify this object.. [optional]  # noqa: E501
            secure_boot (str): Secure boot if set to enabled, enforces that device boots using only software that is trusted by the Original Equipment Manufacturer (OEM).. [optional] if omitted the server will use the default value of "Disabled"  # noqa: E501
