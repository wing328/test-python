...
class StoragePureControllerRelationship(ModelComposed):
    ...
    def __init__(self, class_id, *args, **kwargs):  # noqa: E501
        """StoragePureControllerRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            operational_mode (str): Controller running mode, Primary or Secondary.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
            status (str): Status of the storage controller.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
