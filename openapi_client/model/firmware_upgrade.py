...
class FirmwareUpgrade(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'exclude_component_list': ([str],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """FirmwareUpgrade - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            exclude_component_list ([str]): [optional]  # noqa: E501
            ...
            status (str): Status of the upgrade operation.. [optional] if omitted the server will use the default value of "NONE"  # noqa: E501
            upgrade_type (str): Desired upgrade mode to choose either direct download based upgrade or network share upgrade.. [optional] if omitted the server will use the default value of "direct_upgrade"  # noqa: E501
