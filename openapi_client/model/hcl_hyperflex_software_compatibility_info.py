...
class HclHyperflexSoftwareCompatibilityInfo(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'constraints': ([HclConstraint],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            constraints ([HclConstraint]): [optional]  # noqa: E501
            hxdp_version (str): HXDP component software version.. [optional]  # noqa: E501
            hypervisor_type (str): Type fo Hypervisor the HyperFlex components versions are compatible with. For example ESX, Hyperv or KVM.. [optional] if omitted the server will use the default value of "ESXi"  # noqa: E501
