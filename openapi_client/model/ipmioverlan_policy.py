...
class IpmioverlanPolicy(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            enabled (bool): State of the IPMI Over LAN service on the endpoint.. [optional]  # noqa: E501
            ...
            is_encryption_key_set (bool): Indicates whether the value of the &#39;encryptionKey&#39; property has been set.. [optional]  # noqa: E501
            privilege (str): The highest privilege level that can be assigned to an IPMI session on a server.. [optional] if omitted the server will use the default value of "admin"  # noqa: E501
