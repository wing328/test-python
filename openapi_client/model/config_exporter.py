...
class ConfigExporter(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            items ([ConfigMoRef]): [optional]  # noqa: E501
            name (str): An identifier for the exporter instance.. [optional]  # noqa: E501
            status (str): Status of the export operation.. [optional] if omitted the server will use the default value of ""  # noqa: E501
