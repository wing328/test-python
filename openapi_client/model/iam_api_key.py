...
class IamApiKey(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            hash_algorithm (str): The cryptographic hash algorithm to calculate the message digest.. [optional] if omitted the server will use the default value of "SHA256"  # noqa: E501
            ...
            signing_algorithm (str): The signing algorithm used by the client to authenticate API requests to Intersight. The signing algorithm must be compatible with the key generation specification.. [optional] if omitted the server will use the default value of "RSASSA-PKCS1-v1_5"  # noqa: E501
