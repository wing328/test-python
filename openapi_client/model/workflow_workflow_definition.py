...
class WorkflowWorkflowDefinition(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'tasks': ([WorkflowWorkflowTask],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            label (str): A user friendly short name to identify the workflow. Name can only contain letters (a-z, A-Z), numbers (0-9), hyphen (-), period (.), colon (:), space ( ) or an underscore (_).. [optional]  # noqa: E501
            license_entitlement (str): License entitlement required to run this workflow. It is calculated based on the highest license requirement of all its tasks.. [optional] if omitted the server will use the default value of "Base"  # noqa: E501
            ...
            tasks ([WorkflowWorkflowTask]): [optional]  # noqa: E501
            ...
            version (int): The version of the workflow to support multiple versions.. [optional]  # noqa: E501
