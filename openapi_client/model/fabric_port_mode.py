...
def lazy_import():
    ...
    globals()['FabricPortModeAllOf'] = FabricPortModeAllOf
...
class FabricPortMode(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """FabricPortMode - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            custom_mode (str): Custom Port Mode specified for the port range.. [optional] if omitted the server will use the default value of "FibreChannel"  # noqa: E501
