...
class ConnectorpackConnectorPackUpgrade(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            connector_pack_op_type (str): The type of operation to be performed on UCS Director.. [optional] if omitted the server will use the default value of "Install"  # noqa: E501
