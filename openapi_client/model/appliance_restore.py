...
class ApplianceRestore(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            status (str): Status of the restore managed object.. [optional] if omitted the server will use the default value of "Started"  # noqa: E501
            ...
            protocol (str): Communication protocol used by the file server (e.g. scp or sftp).. [optional] if omitted the server will use the default value of "scp"  # noqa: E501
