...
class WorkflowDecisionTask(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'decision_cases': ([WorkflowDecisionCase],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            decision_cases ([WorkflowDecisionCase]): [optional]  # noqa: E501
            ...
            input_parameters (bool, date, datetime, dict, float, int, list, str, none_type): JSON formatted map that defines the input given to the decision task. The inputs are used as variables in the condition property of decision task. The input variables can be static values like \&quot;hello\&quot; , \&quot;24\&quot;, \&quot;true\&quot; OR previous task outputs/workflow inputs like \&quot;${task2.output.var1}}\&quot;. The input variables are referrenced as $.inputVariableName in the condition property.. [optional]  # noqa: E501
