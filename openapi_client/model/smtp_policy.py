...
class SmtpPolicy(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            enabled (bool): If enabled, controls the state of the SMTP client service on the managed device.. [optional]  # noqa: E501
            min_severity (str): Minimum fault severity level to receive email notifications. Email notifications are sent for all faults whose severity is equal to or greater than the chosen level.. [optional] if omitted the server will use the default value of "critical"  # noqa: E501
            ...
            smtp_port (int): Port number used by the SMTP server for outgoing SMTP communication.. [optional]  # noqa: E501
            smtp_recipients ([str]): [optional]  # noqa: E501
