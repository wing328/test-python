...
class BootSdCard(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            lun (int): The Logical Unit Number (LUN) of the device.. [optional]  # noqa: E501
            subtype (str): The subtype for the selected device type.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
