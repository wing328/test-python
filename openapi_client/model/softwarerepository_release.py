...
class SoftwarerepositoryRelease(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            type (str): The platform release type for which the images are released. This can be a fabric switch or compute server hardware.. [optional] if omitted the server will use the default value of "FabricSwitch"  # noqa: E501
