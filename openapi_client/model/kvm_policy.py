...
class KvmPolicy(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            enable_local_server_video (bool): If enabled, displays KVM session on any monitor attached to the server.. [optional]  # noqa: E501
            enable_video_encryption (bool): If enabled, encrypts all video information sent through KVM.. [optional]  # noqa: E501
            enabled (bool): State of the vKVM service on the endpoint.. [optional]  # noqa: E501
            maximum_sessions (int): The maximum number of concurrent KVM sessions allowed.. [optional]  # noqa: E501
            remote_port (int): The port used for KVM communication.. [optional]  # noqa: E501
