...
class ServerProfile(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            is_pmc_deployed_secure_passphrase_set (bool): Indicates whether the value of the &#39;pmcDeployedSecurePassphrase&#39; property has been set.. [optional]  # noqa: E501
            ...
            target_platform (str): The platform for which the server profile is applicable. It can either be a server that is operating in standalone mode or which is attached to a Fabric Interconnect managed by Intersight.. [optional] if omitted the server will use the default value of "Standalone"  # noqa: E501
            ...
            name (str): Name of the concrete profile.. [optional]  # noqa: E501
            type (str): Defines the type of the profile. Accepted value is instance.. [optional] if omitted the server will use the default value of "instance"  # noqa: E501
            src_template (PolicyAbstractProfileRelationship): [optional]  # noqa: E501
            action (str): User initiated action. Each profile type has its own supported actions. For HyperFlex cluster profile, the supported actions are -- Validate, Deploy, Continue, Retry, Abort, Unassign For server profile, the support actions are -- Deploy, Unassign.. [optional]  # noqa: E501
