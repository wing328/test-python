...
class WorkflowEnumEntry(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            label (str): Label for the enum value. A user friendly short string to identify the enum value.. [optional]  # noqa: E501
            value (str): Enum value for this enum entry. Value will be passed to the workflow as string type for execution.. [optional]  # noqa: E501
        """
