...
class FirmwareDistributable(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            origin (str): The source of the distributable. If it has been created by the user or system.. [optional] if omitted the server will use the default value of "System"  # noqa: E501
