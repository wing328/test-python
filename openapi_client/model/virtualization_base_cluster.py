...
def lazy_import():
    ...
    globals()['VirtualizationBaseClusterAllOf'] = VirtualizationBaseClusterAllOf
...
class VirtualizationBaseCluster(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """VirtualizationBaseCluster - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status (str): Cluster health status as reported by the hypervisor platform.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
