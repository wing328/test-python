...
def lazy_import():
    ...
    globals()['BootIscsiAllOf'] = BootIscsiAllOf


class BootIscsi(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """BootIscsi - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            port (int): Port ID of the ISCSI boot device.. [optional]  # noqa: E501
