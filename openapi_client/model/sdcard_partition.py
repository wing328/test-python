...
class SdcardPartition(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'type': (str,),  # noqa: E501
            'virtual_drives': ([SdcardVirtualDrive],),  # noqa: E501
        }
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            type (str): This specifies the type of the partition. Allowed values are OS, Utility.. [optional] if omitted the server will use the default value of "OS"  # noqa: E501
            virtual_drives ([SdcardVirtualDrive]): [optional]  # noqa: E501
        """
