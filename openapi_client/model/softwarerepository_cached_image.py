...
class SoftwarerepositoryCachedImage(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'path': (str,),  # noqa: E501
            'registered_workflows': ([str],),  # noqa: E501
            ...
            'download_error': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            cache_state (str): The state  of this file in the endpoint The importState is updated during the cache operation and as part of the cache monitoring process.. [optional] if omitted the server will use the default value of "ReadyForImport"  # noqa: E501
            ...
            registered_workflows ([str]): [optional]  # noqa: E501
            ...
            download_error (bool, date, datetime, dict, float, int, list, str, none_type): Any error encountered. Set to empty when download is in progress or completed.} type: string. [optional]  # noqa: E501
