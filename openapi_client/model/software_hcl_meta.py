...
class SoftwareHclMeta(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            content_type (str): The type of content that the Json file holds (Incremental or full dump).. [optional] if omitted the server will use the default value of "Full"  # noqa: E501
