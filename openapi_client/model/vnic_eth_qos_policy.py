...
def lazy_import():
    ...
    globals()['VnicEthQosPolicyAllOf'] = VnicEthQosPolicyAllOf


class VnicEthQosPolicy(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """VnicEthQosPolicy - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            rate_limit (int): The value in Mbps (0-10G/40G/100G depending on Adapter Model) to use for limiting the data rate on the virtual interface. Setting this to zero will turn rate limiting off.. [optional]  # noqa: E501
            trust_host_cos (bool): Enables usage of the Class of Service provided by the operating system.. [optional]  # noqa: E501
