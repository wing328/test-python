...
class EquipmentIdentitySummary(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'io_card_identity_list': ([EquipmentIoCardIdentity],),  # noqa: E501
            'lifecycle': (str,),  # noqa: E501
            'model': (str,),  # noqa: E501
            'pending_discovery': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'pending_discovery': 'PendingDiscovery',  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            admin_action (str): Updated by UI/API to trigger specific chassis action type.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            admin_action_state (str): The state of Maintenance Action performed. This will have three states. Applying - Action is in progress. Applied - Action is completed and applied. Failed - Action has failed.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            chassis_id (int): Chassis Identifier of a blade server.. [optional]  # noqa: E501
            device_mo_id (str): FI Device registration Mo ID.. [optional]  # noqa: E501
            identifier (int): Numeric Identifier assigned by the management system to the equipment.. [optional]  # noqa: E501
            io_card_identity_list ([EquipmentIoCardIdentity]): [optional]  # noqa: E501
            lifecycle (str): The equipment&#39;s lifecycle status.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            model (str): The vendor provided model name for the equipment.. [optional]  # noqa: E501
            pending_discovery (str): Indicates pending discovery flag.. [optional]  # noqa: E501
