...
class FirmwareUpgradeStatus(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'download_message': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            download_error (str): The error message from the endpoint during the download.. [optional]  # noqa: E501
            download_message (bool, date, datetime, dict, float, int, list, str, none_type): The message from the endpoint during the download.} type: string. [optional]  # noqa: E501
            ...
            ep_power_status (str): The server power status after the upgrade request is submitted in the endpoint.. [optional] if omitted the server will use the default value of "none"  # noqa: E501
            ...
            overallstatus (str): The overall status of the operation.. [optional] if omitted the server will use the default value of "none"  # noqa: E501
            pending_type (str): Pending reason for the upgrade waiting.. [optional] if omitted the server will use the default value of "none"  # noqa: E501
