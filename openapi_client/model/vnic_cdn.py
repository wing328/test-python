...
class VnicCdn(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            source (str): Source of the CDN. It can either be user specified or be the same as the vNIC name.. [optional] if omitted the server will use the default value of "vnic"  # noqa: E501
