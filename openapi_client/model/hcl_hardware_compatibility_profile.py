...
class HclHardwareCompatibilityProfile(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            error_code (str): Error code indicating the compatibility status.. [optional] if omitted the server will use the default value of "Success"  # noqa: E501
            ...
            products ([HclProduct]): [optional]  # noqa: E501
            ...
            version_type (str): Type of the UCS version indicating whether it is a UCSM release vesion or a IMC release.. [optional] if omitted the server will use the default value of "UCSM"  # noqa: E501
        """
