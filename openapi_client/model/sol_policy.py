...
class SolPolicy(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            baud_rate (int): Baud Rate used for Serial Over LAN communication.. [optional] if omitted the server will use the default value of 9600  # noqa: E501
            com_port (str): Serial port through which the system routes Serial Over LAN communication. This field is available only on some Cisco UCS C-Series servers. If it is unavailable, the server uses COM port 0 by default.. [optional] if omitted the server will use the default value of "com0"  # noqa: E501
            enabled (bool): State of Serial Over LAN service on the endpoint.. [optional]  # noqa: E501
            ssh_port (int): SSH port used to access Serial Over LAN directly. Enables bypassing Cisco IMC shell to provide direct access to Serial Over LAN.. [optional]  # noqa: E501
