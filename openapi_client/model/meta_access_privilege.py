...
class MetaAccessPrivilege(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            method (str): The type of CRUD operation (create, read, update, delete) for which an access privilege is required.. [optional] if omitted the server will use the default value of "Update"  # noqa: E501
