...
class User(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'arbitrary_object': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'arbitrary_nullable_object': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            arbitrary_object ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): test code generation for objects Value must be a map of strings to values. It cannot be the 'null' value.. [optional]  # noqa: E501
            arbitrary_nullable_object ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): test code generation for nullable objects. Value must be a map of strings to values or the 'null' value.. [optional]  # noqa: E501
