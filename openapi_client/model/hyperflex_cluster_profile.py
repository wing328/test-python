...
class HyperflexClusterProfile(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            hypervisor_type (str): The hypervisor type for the HyperFlex cluster.. [optional] if omitted the server will use the default value of "ESXi"  # noqa: E501
            ...
            mgmt_platform (str): The management platform for the HyperFlex cluster.. [optional] if omitted the server will use the default value of "FI"  # noqa: E501
