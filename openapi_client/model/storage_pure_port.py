...
class StoragePurePort(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            status (str): Status of storage array port.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
            type (str): Port type - possible values are FC, FCoE and iSCSI.. [optional] if omitted the server will use the default value of "FC"  # noqa: E501
