...
class VnicScsiQueueSettings(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            count (int): The number of SCSI I/O queue resources the system should allocate.. [optional]  # noqa: E501
            ring_size (int): The number of descriptors in each SCSI I/O queue.. [optional]  # noqa: E501
        """
