...
class ApplianceSystemInfo(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            cloud_conn_status (str): Connection state of the Intersight Appliance to the Intersight.. [optional] if omitted the server will use the default value of ""  # noqa: E501
            ...
            operational_status (str): Operational status of the Intersight Appliance cluster.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
            ...
            time_zone (str): Timezone of the Intersight Appliance.. [optional] if omitted the server will use the default value of "Pacific/Niue"  # noqa: E501
