...
class IamLdapPolicy(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            '_0_idp': (IamIdpRelationship,),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            enabled (bool): LDAP server performs authentication.. [optional]  # noqa: E501
            user_search_precedence (str): Search precedence between local user database and LDAP user database.. [optional] if omitted the server will use the default value of "LocalUserDb"  # noqa: E501
            _0_idp (IamIdpRelationship): [optional]  # noqa: E501
