...
class WorkflowCliCommand(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'expect_prompts': ([WorkflowExpectPrompt],),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            expect_prompts ([WorkflowExpectPrompt]): [optional]  # noqa: E501
            ...
            type (str): The type of the command - can be interactive or non-interactive.. [optional] if omitted the server will use the default value of "NonInteractive"  # noqa: E501
