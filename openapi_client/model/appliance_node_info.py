...
class ApplianceNodeInfo(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            operational_status (str): Operational status of the Intersight Appliance node.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
