...
class WorkflowMessage(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            message (bool, date, datetime, dict, float, int, list, str, none_type): An i18n message that can be translated in multiple languages to support internationalization.} type: string. [optional]  # noqa: E501
            severity (str): The severity of the Task or Workflow message warning/error/info etc.. [optional] if omitted the server will use the default value of "Info"  # noqa: E501
        """
