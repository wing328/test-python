...
class OsWindowsParameters(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            edition (str): Lists all the editions supported for Windows Server installation.. [optional] if omitted the server will use the default value of "Standard"  # noqa: E501
        """
