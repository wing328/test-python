...
class WorkflowWebApi(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'response_spec': (ContentGrammar,),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            endpoint_request_type (str): If the target type is Endpoint, this property determines whether the request is to be handled as internal request or external request by the device connector.. [optional] if omitted the server will use the default value of "Internal"  # noqa: E501
            ...
            method (str): The HTTP method to be executed in the given URL (GET, POST, PUT, etc). If the value is not specified, GET will be used as default.. [optional]  # noqa: E501
            ...
            target_type (str): If the web API is to be executed in a remote device connected to the Intersight through device connector, &#39;Endpoint&#39; is expected as the value whereas if the API is an Intersight API, &#39;Local&#39; is expected as the value.. [optional] if omitted the server will use the default value of "Endpoint"  # noqa: E501
            ...
            response_spec (ContentGrammar): [optional]  # noqa: E501
