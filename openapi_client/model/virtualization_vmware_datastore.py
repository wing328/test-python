...
class VirtualizationVmwareDatastore(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            status (str): Datastore health status, as reported by the hypervisor platform.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
            ...
            type (str): A string indicating the type of the datastore (VMFS, NFS, etc).. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
