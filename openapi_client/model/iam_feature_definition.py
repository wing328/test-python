...
class IamFeatureDefinition(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """IamFeatureDefinition - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            feature (str): The beta feature that will be enabled for specific account.. [optional] if omitted the server will use the default value of "IWO"  # noqa: E501
        """
