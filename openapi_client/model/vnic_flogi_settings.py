...
class VnicFlogiSettings(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            retries (int): The number of times that the system tries to log in to the fabric after the first failure.. [optional]  # noqa: E501
            timeout (int): The number of milliseconds that the system waits before it tries to log in again.. [optional]  # noqa: E501
        """
