...
class ForecastApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_forecast_catalog_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_forecast_catalog_by_moid = Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/forecast/Catalogs/{Moid}',
                'operation_id': 'get_forecast_catalog_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__get_forecast_catalog_by_moid
        )

        def __get_forecast_catalog_list(
            self,
            **kwargs
        ):
            """Read a 'forecast.Catalog' resource.  # noqa: E501
        ...
        self.get_forecast_catalog_list = Endpoint(
            settings={
                'response_type': (ForecastCatalogResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2'
                ],
                'endpoint_path': '/api/v1/forecast/Catalogs',
                'operation_id': 'get_forecast_catalog_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_forecast_catalog_list
        )

        def __get_forecast_definition_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_forecast_definition_by_moid = Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/forecast/Definitions/{Moid}',
                'operation_id': 'get_forecast_definition_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_forecast_definition_by_moid
        )

        def __get_forecast_definition_list(
            self,
            **kwargs
        ):
            """Read a 'forecast.Definition' resource.  # noqa: E501
        ...
        self.get_forecast_definition_list = Endpoint(
            settings={
                'response_type': (ForecastDefinitionResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2'
                ],
                'endpoint_path': '/api/v1/forecast/Definitions',
                'operation_id': 'get_forecast_definition_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_forecast_definition_list
        )

        def __get_forecast_instance_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_forecast_instance_by_moid = Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/forecast/Instances/{Moid}',
                'operation_id': 'get_forecast_instance_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_forecast_instance_by_moid
        )

        def __get_forecast_instance_list(
            self,
            **kwargs
        ):
            """Read a 'forecast.Instance' resource.  # noqa: E501
        ...
        self.get_forecast_instance_list = Endpoint(
            settings={
                'response_type': (ForecastInstanceResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2'
                ],
                'endpoint_path': '/api/v1/forecast/Instances',
                'operation_id': 'get_forecast_instance_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_forecast_instance_list
        )
