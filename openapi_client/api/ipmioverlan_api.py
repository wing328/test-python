...
class IpmioverlanApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_ipmioverlan_policy(
            self,
            ipmioverlan_policy,
            **kwargs
        ):
            ...
            Args:
                ipmioverlan_policy (IpmioverlanPolicy): The &#39;ipmioverlan.Policy&#39; resource to create.
            ...
            kwargs['ipmioverlan_policy'] = \
                ipmioverlan_policy
            return self.call_with_http_info(**kwargs)

        self.create_ipmioverlan_policy = Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/ipmioverlan/Policies',
                'operation_id': 'create_ipmioverlan_policy',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__create_ipmioverlan_policy
        )

        def __delete_ipmioverlan_policy(
            self,
            moid,
            **kwargs
        ):
        ...
        self.delete_ipmioverlan_policy = Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/ipmioverlan/Policies/{Moid}',
                'operation_id': 'delete_ipmioverlan_policy',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_ipmioverlan_policy
        )

        def __get_ipmioverlan_policy_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_ipmioverlan_policy_by_moid = Endpoint(
            settings={
                'response_type': (IpmioverlanPolicy,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/ipmioverlan/Policies/{Moid}',
                'operation_id': 'get_ipmioverlan_policy_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_ipmioverlan_policy_by_moid
        )

        def __get_ipmioverlan_policy_list(
            self,
            **kwargs
        ):
            """Read a 'ipmioverlan.Policy' resource.  # noqa: E501
        ...
        self.get_ipmioverlan_policy_list = Endpoint(
            settings={
                'response_type': (IpmioverlanPolicyResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2'
                ...
                'endpoint_path': '/api/v1/ipmioverlan/Policies',
                'operation_id': 'get_ipmioverlan_policy_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_ipmioverlan_policy_list
        )

        def __patch_ipmioverlan_policy(
            self,
            moid,
            ipmioverlan_policy,
            **kwargs
            ...
            Args:
                moid (str): The unique Moid identifier of a resource instance.
                ipmioverlan_policy (IpmioverlanPolicy): The &#39;ipmioverlan.Policy&#39; resource to update.
        ...
        self.patch_ipmioverlan_policy = Endpoint(
            settings={
                'response_type': (IpmioverlanPolicy,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/ipmioverlan/Policies/{Moid}',
                'operation_id': 'patch_ipmioverlan_policy',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__patch_ipmioverlan_policy
        )

        def __update_ipmioverlan_policy(
            self,
            moid,
            ipmioverlan_policy,
            **kwargs
        ...
        self.update_ipmioverlan_policy = Endpoint(
            settings={
                'response_type': (IpmioverlanPolicy,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/ipmioverlan/Policies/{Moid}',
                'operation_id': 'update_ipmioverlan_policy',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__update_ipmioverlan_policy
        )
