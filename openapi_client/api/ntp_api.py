...
class NtpApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_ntp_policy = Endpoint(
            settings={
        ...
        self.delete_ntp_policy = Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
        ...
        self.get_ntp_policy_by_moid = Endpoint(
            settings={
                'response_type': (NtpPolicy,),
                'auth': [
                    'cookieAuth',
        ...
        self.get_ntp_policy_list = Endpoint(
            settings={
        ...
        self.patch_ntp_policy = Endpoint(
            settings={
                'response_type': (NtpPolicy,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_ntp_policy = Endpoint(
            settings={
                'response_type': (NtpPolicy,),
                'auth': [
                    'cookieAuth',
