    ...
    def __init__(self, api_client=None):
        ...
        def __create_ssh_policy(
            ...
            **kwargs
            ...
            Args:
                ssh_policy (SshPolicy): The &#39;ssh.Policy&#39; resource to create.
        ...
        self.create_ssh_policy = Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/ssh/Policies',
                'operation_id': 'create_ssh_policy',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__create_ssh_policy
        )

        def __delete_ssh_policy(
            self,
            moid,
            **kwargs
        ):
        ...
        self.delete_ssh_policy = Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/ssh/Policies/{Moid}',
                'operation_id': 'delete_ssh_policy',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_ssh_policy
        )

        def __get_ssh_policy_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_ssh_policy_by_moid = Endpoint(
            settings={
                'response_type': (SshPolicy,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/ssh/Policies/{Moid}',
                'operation_id': 'get_ssh_policy_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_ssh_policy_by_moid
        )

        def __get_ssh_policy_list(
            self,
            **kwargs
        ):
            """Read a 'ssh.Policy' resource.  # noqa: E501
        ...
        self.get_ssh_policy_list = Endpoint(
            settings={
                'response_type': (SshPolicyResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2'
                ...
                'endpoint_path': '/api/v1/ssh/Policies',
                'operation_id': 'get_ssh_policy_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_ssh_policy_list
        )

        def __patch_ssh_policy(
            self,
            moid,
            ssh_policy,
            **kwargs
            ...
            Args:
                moid (str): The unique Moid identifier of a resource instance.
                ssh_policy (SshPolicy): The &#39;ssh.Policy&#39; resource to update.
        ...
        self.patch_ssh_policy = Endpoint(
            settings={
                'response_type': (SshPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_ssh_policy
        )

        def __update_ssh_policy(
            self,
            moid,
            ssh_policy,
            **kwargs
        ...
        self.update_ssh_policy = Endpoint(
            settings={
                'response_type': (SshPolicy,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/ssh/Policies/{Moid}',
                'operation_id': 'update_ssh_policy',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
