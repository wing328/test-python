...
class VrfApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_vrf_vrf_by_moid = Endpoint(
            settings={
                'response_type': (VrfVrf,),
                'auth': [
                    'cookieAuth',
        ...
        self.get_vrf_vrf_list = Endpoint(
            settings={
