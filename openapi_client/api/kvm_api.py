...
class KvmApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_kvm_policy = Endpoint(
            settings={
        ...
        self.delete_kvm_policy = Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
        ...
        def __get_kvm_kvm_session_by_moid(
            self,
            moid,
            **kwargs
        ):
            """Read a 'kvm.KvmSession' resource.  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_kvm_kvm_session_by_moid(moid, async_req=True)
            >>> result = thread.get()
        ...
        self.get_kvm_kvm_session_by_moid = Endpoint(
            settings={
                'response_type': (KvmKvmSession,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2'
                ],
                'endpoint_path': '/api/v1/kvm/KvmSessions/{Moid}',
                'operation_id': 'get_kvm_kvm_session_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_kvm_kvm_session_by_moid
        )

        def __get_kvm_kvm_session_list(
            self,
            **kwargs
        ):
            """Read a 'kvm.KvmSession' resource.  # noqa: E501
            ...
            >>> thread = api.get_kvm_kvm_session_list(async_req=True)
            >>> result = thread.get()
        ...
        self.get_kvm_kvm_session_list = Endpoint(
            settings={
                'response_type': (KvmKvmSessionResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2'
                ],
                'endpoint_path': '/api/v1/kvm/KvmSessions',
                'operation_id': 'get_kvm_kvm_session_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_kvm_kvm_session_list
        )
        ...
        self.get_kvm_policy_by_moid = Endpoint(
            settings={
                'response_type': (KvmPolicy,),
                'auth': [
                    'cookieAuth',
        ...
        self.get_kvm_policy_list = Endpoint(
            settings={
        ...
        self.patch_kvm_policy = Endpoint(
            settings={
                'response_type': (KvmPolicy,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_kvm_policy = Endpoint(
            settings={
                'response_type': (KvmPolicy,),
                'auth': [
                    'cookieAuth',
