...
class BootApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_boot_precision_policy = Endpoint(
            settings={
        ...
        self.delete_boot_precision_policy = Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
        ...
        self.get_boot_device_boot_mode_by_moid = Endpoint(
            settings={
        ...
        self.get_boot_device_boot_mode_list = Endpoint(
            settings={
        ...
        self.get_boot_precision_policy_by_moid = Endpoint(
            settings={
                'response_type': (BootPrecisionPolicy,),
                'auth': [
                    'cookieAuth',
        ...
        self.get_boot_precision_policy_list = Endpoint(
            settings={
        ...
        self.patch_boot_device_boot_mode = Endpoint(
            settings={
                'response_type': (BootDeviceBootMode,),
                'auth': [
                    'cookieAuth',
        ...
        self.patch_boot_precision_policy = Endpoint(
            settings={
                'response_type': (BootPrecisionPolicy,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_boot_device_boot_mode = Endpoint(
            settings={
                'response_type': (BootDeviceBootMode,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_boot_precision_policy = Endpoint(
            settings={
                'response_type': (BootPrecisionPolicy,),
                'auth': [
                    'cookieAuth',
