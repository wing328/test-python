...
class FakeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.fake_outer_boolean_serialize = _Endpoint(
            settings={
                'response_type': (bool,),
                'auth': [],
        ...
        self.fake_outer_composite_serialize = _Endpoint(
            settings={
        ...
        self.fake_outer_number_serialize = _Endpoint(
            settings={
                'response_type': (float,),
                'auth': [],
        ...
        self.fake_outer_string_serialize = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [],
