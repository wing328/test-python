...
class InventoryApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_inventory_request = Endpoint(
            settings={
        ...
        self.get_inventory_device_info_by_moid = Endpoint(
            settings={
        ...
        self.get_inventory_device_info_list = Endpoint(
            settings={
        ...
        self.get_inventory_dn_mo_binding_by_moid = Endpoint(
            settings={
        ...
        self.get_inventory_dn_mo_binding_list = Endpoint(
            settings={
        ...
        self.get_inventory_generic_inventory_by_moid = Endpoint(
            settings={
        ...
        self.get_inventory_generic_inventory_holder_by_moid = Endpoint(
            settings={
        ...
        self.get_inventory_generic_inventory_holder_list = Endpoint(
            settings={
        ...
        self.get_inventory_generic_inventory_list = Endpoint(
            settings={
        ...
        def __get_inventory_uem_connection_by_moid(
            self,
            moid,
            **kwargs
        ):
            """Read a 'inventory.UemConnection' resource.  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_inventory_uem_connection_by_moid(moid, async_req=True)
            >>> result = thread.get()
        ...
        self.get_inventory_uem_connection_by_moid = Endpoint(
            settings={
                'response_type': (InventoryUemConnection,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2'
                ],
                'endpoint_path': '/api/v1/inventory/UemConnections/{Moid}',
                'operation_id': 'get_inventory_uem_connection_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_inventory_uem_connection_by_moid
        )

        def __get_inventory_uem_connection_list(
            self,
            **kwargs
        ):
            """Read a 'inventory.UemConnection' resource.  # noqa: E501
            ...
            >>> thread = api.get_inventory_uem_connection_list(async_req=True)
            >>> result = thread.get()
        ...
        self.get_inventory_uem_connection_list = Endpoint(
            settings={
                'response_type': (InventoryUemConnectionResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2'
                ],
                'endpoint_path': '/api/v1/inventory/UemConnections',
                'operation_id': 'get_inventory_uem_connection_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_inventory_uem_connection_list
        )
        ...
        self.patch_inventory_generic_inventory = Endpoint(
            settings={
                'response_type': (InventoryGenericInventory,),
                'auth': [
                    'cookieAuth',
        ...
        self.patch_inventory_generic_inventory_holder = Endpoint(
            settings={
                'response_type': (InventoryGenericInventoryHolder,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_inventory_generic_inventory = Endpoint(
            settings={
                'response_type': (InventoryGenericInventory,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_inventory_generic_inventory_holder = Endpoint(
            settings={
                'response_type': (InventoryGenericInventoryHolder,),
                'auth': [
                    'cookieAuth',
