...
class AssetApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_asset_device_claim = Endpoint(
            settings={
        ...
        def __create_asset_managed_device(
            self,
            ...
            **kwargs
            ...
            Args:
                asset_managed_device (AssetManagedDevice): The &#39;asset.ManagedDevice&#39; resource to create.
            ...
            kwargs['_host_index'] = kwargs.get('_host_index')
            kwargs['asset_managed_device'] = \
                asset_managed_device
            return self.call_with_http_info(**kwargs)

        self.create_asset_managed_device = Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/asset/ManagedDevices',
                'operation_id': 'create_asset_managed_device',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__create_asset_managed_device
        )
        ...
        self.create_asset_target = Endpoint(
            settings={
        ...
        self.delete_asset_device_claim = Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
        ...
        self.delete_asset_device_registration = Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
        ...
        def __delete_asset_managed_device(
            self,
            moid,
            **kwargs
        ):
        ...
        self.delete_asset_managed_device = Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/asset/ManagedDevices/{Moid}',
                'operation_id': 'delete_asset_managed_device',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_asset_managed_device
        )
        ...
        self.delete_asset_target = Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
        ...
        self.get_asset_cluster_member_by_moid = Endpoint(
            settings={
        ...
        self.get_asset_cluster_member_list = Endpoint(
            settings={
        ...
        self.get_asset_device_configuration_by_moid = Endpoint(
            settings={
        ...
        self.get_asset_device_configuration_list = Endpoint(
            settings={
        ...
        self.get_asset_device_connector_manager_by_moid = Endpoint(
            settings={
        ...
        self.get_asset_device_connector_manager_list = Endpoint(
            settings={
        ...
        self.get_asset_device_contract_information_by_moid = Endpoint(
            settings={
        ...
        self.get_asset_device_contract_information_list = Endpoint(
            settings={
        ...
        self.get_asset_device_registration_by_moid = Endpoint(
            settings={
        ...
        self.get_asset_device_registration_list = Endpoint(
            settings={
        ...
        def __get_asset_managed_device_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_asset_managed_device_by_moid = Endpoint(
            settings={
                'response_type': (AssetManagedDevice,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/asset/ManagedDevices/{Moid}',
                'operation_id': 'get_asset_managed_device_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_asset_managed_device_by_moid
        )

        def __get_asset_managed_device_list(
            self,
            **kwargs
        ):
            """Read a 'asset.ManagedDevice' resource.  # noqa: E501
        ...
        self.get_asset_managed_device_list = Endpoint(
            settings={
                'response_type': (AssetManagedDeviceResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2'
                ...
                'endpoint_path': '/api/v1/asset/ManagedDevices',
                'operation_id': 'get_asset_managed_device_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_asset_managed_device_list
        )
        ...
        self.get_asset_target_by_moid = Endpoint(
            settings={
                'response_type': (AssetTarget,),
                'auth': [
                    'cookieAuth',
        ...
        self.get_asset_target_list = Endpoint(
            settings={
        ...
        self.patch_asset_device_configuration = Endpoint(
            settings={
                'response_type': (AssetDeviceConfiguration,),
                'auth': [
                    'cookieAuth',
        ...
        self.patch_asset_device_contract_information = Endpoint(
            settings={
                'response_type': (AssetDeviceContractInformation,),
                'auth': [
                    'cookieAuth',
        ...
        self.patch_asset_device_registration = Endpoint(
            settings={
                'response_type': (AssetDeviceRegistration,),
                'auth': [
                    'cookieAuth',
        ...
        def __patch_asset_managed_device(
            self,
            moid,
            asset_managed_device,
            **kwargs
            ...
            Args:
                moid (str): The unique Moid identifier of a resource instance.
                asset_managed_device (AssetManagedDevice): The &#39;asset.ManagedDevice&#39; resource to update.
        ...
        self.patch_asset_managed_device = Endpoint(
            settings={
                'response_type': (AssetManagedDevice,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/asset/ManagedDevices/{Moid}',
                'operation_id': 'patch_asset_managed_device',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__patch_asset_managed_device
        )
        ...
        self.patch_asset_target = Endpoint(
            settings={
                'response_type': (AssetTarget,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_asset_device_configuration = Endpoint(
            settings={
                'response_type': (AssetDeviceConfiguration,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_asset_device_contract_information = Endpoint(
            settings={
                'response_type': (AssetDeviceContractInformation,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_asset_device_registration = Endpoint(
            settings={
                'response_type': (AssetDeviceRegistration,),
                'auth': [
                    'cookieAuth',
        ...
        def __update_asset_managed_device(
            self,
            moid,
            asset_managed_device,
            **kwargs
        ...
        self.update_asset_managed_device = Endpoint(
            settings={
                'response_type': (AssetManagedDevice,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/asset/ManagedDevices/{Moid}',
                'operation_id': 'update_asset_managed_device',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__update_asset_managed_device
        )
        ...
        self.update_asset_target = Endpoint(
            settings={
                'response_type': (AssetTarget,),
                'auth': [
                    'cookieAuth',
