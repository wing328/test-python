...
from openapi_client.api import ipmioverlan_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    ipmioverlan_policy = IpmioverlanPolicy() # IpmioverlanPolicy | The 'ipmioverlan.Policy' resource to create.
    ...
    try:
        # Create a 'ipmioverlan.Policy' resource.
        api_response = api_instance.create_ipmioverlan_policy(ipmioverlan_policy, if_match=if_match, if_none_match=if_none_match)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling IpmioverlanApi->create_ipmioverlan_policy: %s\n" % e)
```
...
> IpmioverlanPolicyResponse get_ipmioverlan_policy_list()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Read a 'ipmioverlan.Policy' resource.
        api_response = api_instance.get_ipmioverlan_policy_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at, tags=tags)
        pprint(api_response)
    except openapi_client.ApiException as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ipmioverlan_api.IpmioverlanApi(api_client)
    moid = "Moid_example" # str | The unique Moid identifier of a resource instance.
    ipmioverlan_policy = IpmioverlanPolicy() # IpmioverlanPolicy | The 'ipmioverlan.Policy' resource to update.
    if_match = "If-Match_example" # str | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
    ...
    try:
        # Update a 'ipmioverlan.Policy' resource.
        api_response = api_instance.patch_ipmioverlan_policy(moid, ipmioverlan_policy, if_match=if_match)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling IpmioverlanApi->patch_ipmioverlan_policy: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a 'ipmioverlan.Policy' resource.
        api_response = api_instance.update_ipmioverlan_policy(moid, ipmioverlan_policy, if_match=if_match)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling IpmioverlanApi->update_ipmioverlan_policy: %s\n" % e)
```
