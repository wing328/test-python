...
from openapi_client.api import graphics_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = graphics_api.GraphicsApi(api_client)
...
> GraphicsCardResponse get_graphics_card_list()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Read a 'graphics.Card' resource.
        api_response = api_instance.get_graphics_card_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at, tags=tags)
        pprint(api_response)
    except openapi_client.ApiException as e:
...
> GraphicsControllerResponse get_graphics_controller_list()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Read a 'graphics.Controller' resource.
        api_response = api_instance.get_graphics_controller_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at, tags=tags)
        pprint(api_response)
    except openapi_client.ApiException as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = graphics_api.GraphicsApi(api_client)
    moid = "Moid_example" # str | The unique Moid identifier of a resource instance.
    graphics_card = GraphicsCard() # GraphicsCard | The 'graphics.Card' resource to update.
    ...
    try:
        # Update a 'graphics.Card' resource.
        api_response = api_instance.patch_graphics_card(moid, graphics_card, if_match=if_match)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling GraphicsApi->patch_graphics_card: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = graphics_api.GraphicsApi(api_client)
    moid = "Moid_example" # str | The unique Moid identifier of a resource instance.
    graphics_controller = GraphicsController() # GraphicsController | The 'graphics.Controller' resource to update.
    if_match = "If-Match_example" # str | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
    ...
    try:
        # Update a 'graphics.Controller' resource.
        api_response = api_instance.patch_graphics_controller(moid, graphics_controller, if_match=if_match)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling GraphicsApi->patch_graphics_controller: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a 'graphics.Card' resource.
        api_response = api_instance.update_graphics_card(moid, graphics_card, if_match=if_match)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling GraphicsApi->update_graphics_card: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a 'graphics.Controller' resource.
        api_response = api_instance.update_graphics_controller(moid, graphics_controller, if_match=if_match)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling GraphicsApi->update_graphics_controller: %s\n" % e)
```
