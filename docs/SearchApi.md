...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    search_suggest_item = SearchSuggestItem() # SearchSuggestItem | The 'search.SuggestItem' resource to create.
    ...
    try:
        # Create a 'search.SuggestItem' resource.
        api_response = api_instance.create_search_suggest_item(search_suggest_item, if_match=if_match, if_none_match=if_none_match)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling SearchApi->create_search_suggest_item: %s\n" % e)
```
...
> SearchSearchItemResponse get_search_search_item_list()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Read a 'search.SearchItem' resource.
        api_response = api_instance.get_search_search_item_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at, tags=tags)
        pprint(api_response)
    except openapi_client.ApiException as e:
...
> SearchTagItemResponse get_search_tag_item_list()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Read a 'search.TagItem' resource.
        api_response = api_instance.get_search_tag_item_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at, tags=tags)
        pprint(api_response)
    except openapi_client.ApiException as e:
