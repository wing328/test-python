...
from openapi_client.api import ucsd_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ucsd_api.UcsdApi(api_client)
...
> UcsdBackupInfoResponse get_ucsd_backup_info_list()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Read a 'ucsd.BackupInfo' resource.
        api_response = api_instance.get_ucsd_backup_info_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at, tags=tags)
        pprint(api_response)
    except openapi_client.ApiException as e:
