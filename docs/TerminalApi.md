...
from openapi_client.api import terminal_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = terminal_api.TerminalApi(api_client)
...
> TerminalAuditLogResponse get_terminal_audit_log_list()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Read a 'terminal.AuditLog' resource.
        api_response = api_instance.get_terminal_audit_log_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at, tags=tags)
        pprint(api_response)
    except openapi_client.ApiException as e:
