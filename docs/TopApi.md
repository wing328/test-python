...
from openapi_client.api import top_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = top_api.TopApi(api_client)
...
# **get_top_system_list**
> TopSystemResponse get_top_system_list()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Read a 'top.System' resource.
        api_response = api_instance.get_top_system_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at, tags=tags)
        pprint(api_response)
    except openapi_client.ApiException as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = top_api.TopApi(api_client)
    moid = "Moid_example" # str | The unique Moid identifier of a resource instance.
    top_system = TopSystem() # TopSystem | The 'top.System' resource to update.
    ...
    try:
        # Update a 'top.System' resource.
        api_response = api_instance.patch_top_system(moid, top_system, if_match=if_match)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling TopApi->patch_top_system: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a 'top.System' resource.
        api_response = api_instance.update_top_system(moid, top_system, if_match=if_match)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling TopApi->update_top_system: %s\n" % e)
```
