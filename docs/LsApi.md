...
from openapi_client.api import ls_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ls_api.LsApi(api_client)
...
> LsServiceProfileResponse get_ls_service_profile_list()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Read a 'ls.ServiceProfile' resource.
        api_response = api_instance.get_ls_service_profile_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at, tags=tags)
        pprint(api_response)
    except openapi_client.ApiException as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ls_api.LsApi(api_client)
    moid = "Moid_example" # str | The unique Moid identifier of a resource instance.
    ls_service_profile = LsServiceProfile() # LsServiceProfile | The 'ls.ServiceProfile' resource to update.
    ...
    try:
        # Update a 'ls.ServiceProfile' resource.
        api_response = api_instance.patch_ls_service_profile(moid, ls_service_profile, if_match=if_match)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling LsApi->patch_ls_service_profile: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a 'ls.ServiceProfile' resource.
        api_response = api_instance.update_ls_service_profile(moid, ls_service_profile, if_match=if_match)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling LsApi->update_ls_service_profile: %s\n" % e)
```
