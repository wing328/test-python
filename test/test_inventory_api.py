...
class TestInventoryApi(unittest.TestCase):
    ...
    def test_get_inventory_uem_connection_by_moid(self):
        """Test case for get_inventory_uem_connection_by_moid

        Read a 'inventory.UemConnection' resource.  # noqa: E501
        """
        pass

    def test_get_inventory_uem_connection_list(self):
        """Test case for get_inventory_uem_connection_list
