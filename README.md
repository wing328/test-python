...
- Build date: 2016-06-17T00:17:54.027+08:00
...
```sh
pip install git+https://github.com/wing328/test-python.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wing328/test-python.git`)
